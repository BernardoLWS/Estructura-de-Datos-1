...
public class Racional {
    ...
    public Racional(char signo, int numerador, int denominador) { //(-,2,3)
        if (denominador == 0) {
    ...
    // Sumar racionales
    public void Suma(Racional A, Racional B) { //C.Suma(A,B) 1/4 - 1/2 
 ...
 //toString() automaticamente solo colocando el nombre de la variable de la clase ya lo dibuja System.out.printl(C) == System.out.printl(C.toString)
